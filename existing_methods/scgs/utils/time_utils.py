...
class StaticNetwork(nn.Module):
    """
    A neural network that represents a static scene.
    It returns zero deformations and transformations for all inputs.
    """
