    ...
    def __init__(
        ...
        **kwargs
        ...
        for frame in tqdm(j["frames"]):
            fname = path.basename(frame["file_path"]) + ".png"
            fpath = path.join(data_path, fname)
            ...
            all_img_files.append(fname)
        
        if not j["frames"]:
            print(f'No frames found in {data_json}, skipping.')
            return
        ...
        if n_images is not None:
            ...
            all_img_files = all_img_files[0:n_images]
